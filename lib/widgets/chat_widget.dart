...
import '../services/claude_ai.dart';
...
class _ChatWidgetState extends State<ChatWidget> {
  ...
  void initState() {
    ...
    _messages.add(
      const Message(
        text: "Welcome to Space Explorer AI! Ask me anything about space exploration, astronomy, planets, spacecraft, or related topics.",
        fromUser: false,
      ),
    );
  }
  ...
  Future<void> _sendChatMessage(String message) async {
    ...
    try {
      ...
      final text = await ClaudeAIService().chat(message);
